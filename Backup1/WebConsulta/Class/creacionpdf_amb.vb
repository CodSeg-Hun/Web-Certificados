...
Public Class creacionpdf_amb
    ...
    Public Overrides Sub OnEndPage(ByVal writer As PdfWriter, ByVal doc As Document)
        ...
        Dim logo As iTextSharp.text.Image = iTextSharp.text.Image.GetInstance(HttpContext.Current.Server.MapPath("../Images/background_banner_certificado_ambacar.jpg"))
        ...
        cb2.ShowTextAligned(Element.ALIGN_CENTER, "Convenio Ambacar ", doc.PageSize.Width - 10, doc.PageSize.Height / 2, -90)
        cb2.EndText()
        '**********************************************
        ' pie de pagina
        '**********************************************
