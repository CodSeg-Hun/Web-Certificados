...
Public Class ConsultaWeb
    ...
    Function Registro_Actividad(ByVal vehiculo As String, ByVal chasis As String, ByVal motor As String, ByVal usuario As Int64, ByVal impreso As String, _
                                ByVal ipmaquina As String, ByVal pantalla As String, ByVal correo As String, ByVal origen As String, ByVal consultar As Boolean, _
