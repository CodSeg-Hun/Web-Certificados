...
Public Class creacionpdf_coneca
    ...
    Public Overrides Sub OnEndPage(ByVal writer As PdfWriter, ByVal doc As Document)
        ...
        Dim logo As iTextSharp.text.Image = iTextSharp.text.Image.GetInstance("https://www.hunteronline.com.ec/IMGCOTIZADORWEB/Imagenescampanias/background_banner_certificado_coneca.jpg")
