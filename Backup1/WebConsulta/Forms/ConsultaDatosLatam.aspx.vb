...
Public Class ConsultaDatosLatam
    ...
    Private Sub Consultar(ByVal opcion As String)
        Try
            ...
            Else
                ...
                'proceso = 16
            End If
            dtGeneral = obj.ConsultarLatam(Session.Item("user_id"), rdpFechaInicio.SelectedDate.Value.ToString("yyyy/MM/dd").Replace("/", ""), _
                                            rdpFechaFin.SelectedDate.Value.ToString("yyyy/MM/dd").Replace("/", ""), chasis, motor, codigo, proceso, cbm_estado.SelectedValue.ToString, "", "")
...
#Region "DATOS DEL GRID"
    ...
    Protected Sub GeneraPdf_Click()
        Try
            ...
            tabla.SetWidths(New Single() {10.0F, 40.0F, 15.0F, 18.0F, 10.0F})
            ...
            Dim tituloText4 As New PdfPCell(New Phrase("Estos sistemas se encuentran instalados en el (Vehículo/Barco/Avión/Cajero) con las siguientes características:", fontNormal))
