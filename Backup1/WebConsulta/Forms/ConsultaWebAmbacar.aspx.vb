...
Public Class ConsultaWebAmbacar
            ...
            If tipo = "Nuevo" Then
                ...
                If dtdetalle.Tables(0).Rows.Count > 0 Then
                    ...
                    If Session("cbm_tipo") = "C" Then
                        ...
                        grdproductosdetalle.MasterTableView.GetColumn("INSTALACION").Visible = False
                        grdproductosdetalle.MasterTableView.GetColumn("COBERTURA").Visible = True
                    ...
                    ElseIf Session("cbm_tipo") = "I" Then
                        ...
                        textcabecera.Visible = True
                        textcabecera01.Visible = False
                        grdproductosdetalle.MasterTableView.GetColumn("INSTALACION").Visible = True
                        grdproductosdetalle.MasterTableView.GetColumn("COBERTURA").Visible = False
                        'Image1.ImageUrl = "../Images/background_banner_certificado_ins.jpg"
                        Image1.ImageUrl = "../Images/background_banner_certificado_ambacar.jpg"
