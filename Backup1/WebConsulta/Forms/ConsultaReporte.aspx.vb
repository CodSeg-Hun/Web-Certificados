            ...
            If tipo = "Nuevo" Then
                ...
                If dtdetalle.Tables(0).Rows.Count > 0 Then
                    ...
                    If Session("cbm_tipo") = "C" Then
                        If dtdetalle.Tables(0).Rows(0)("CODIGO_CONVENIO").ToString = "024" Or dtdetalle.Tables(0).Rows(0)("PRODUCTO").ToString = "LH" Then
                        ...
                        ElseIf dtdetalle.Tables(0).Rows(0)("PRODUCTO").ToString = "AB" Then
                            Image1.ImageUrl = "../Images/background_banner_certificado_ambacar.jpg"
                            Me.lbltitulodetfljcja.Text = "Certificado de Venta"
                            Me.imgqrgenerator.Visible = False
                        ElseIf dtdetalle.Tables(0).Rows(0)("PRODUCTO").ToString = "MH" Then
