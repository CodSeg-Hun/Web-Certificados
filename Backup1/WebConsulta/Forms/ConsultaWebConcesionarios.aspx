<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ConsultaWebConcesionarios.aspx.vb" Inherits="WebConsulta.ConsultaWebConcesionarios" %>
        ...
        <form id="form1" runat="server">
            ...
            <div id="container">
                <div id="banner">
                    ...
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/background_banner_certificado_concesionario.jpg" />
                </div>
                <div id="content">
                        ...
                        <telerik:RadGrid ID="grdproductosdetalle" runat="server" CellSpacing="0" Culture="es-ES" GridLines="None" Width="670px" Skin="Transparent">
                            <MasterTableView AutoGenerateColumns="False">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn AllowFiltering="False" FilterControlAltText="Filter column column"
                                        HeaderText="COBERTURA" UniqueName="COBERTURA" DataFormatString="{0:dd/MMMM/yyyy}"
                                        DataField="COBERTURA">
                    ...
                    <%--<div class="row_text02" runat="server" id="tex03">
                        Certifica que se ha realizado la instalación de nuestros productos en el (Vehículo/Barco/Cajero) con las siguientes características:
                    </div>
                    <div class="row_text02" runat="server" id="tex04">
                        Certifica que se ha realizado la desinstalación de nuestros productos en el (Vehículo/Barco/Cajero) con las siguientes características:
                    </div>--%>
