<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="Administracion.Master" CodeBehind="ConsultaDatosLatam.aspx.vb" Inherits="WebConsulta.ConsultaDatosLatam" %>
        ...
        <div class="seccion_content_maestra_data">
            <div class="seccion_toolbar_text">
                ...
                <div class="text_maestra">
                    ...
                    <div class="text_maestra_seccion_label_nuevo">Estado</div>
                    <div class="text_maestra_seccion_control">
                ...
                <div class="content_tab_master">
                    <telerik:RadTabStrip ID="radtabdatos" runat="server" AutoPostBack="True"
                        Width="100%" SelectedIndex="0" MultiPageID="RadMultiPage1" Skin="" CssClass="tab_general">
                        <Tabs>
                    ...
                    <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0">
                        <telerik:RadPageView ID="RadPageView1" runat="server" Width="948px">
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" DataKeyNames="CODIGO_VEHICULO"  NoDetailRecordsText="" NoMasterRecordsText="">
                                        ...
                                        <Columns>
                                            <telerik:GridBoundColumn  DataField="ESTADO" FilterControlAltText="Filter ESTADO column" HeaderText="ESTADO" ReadOnly="True"
                                                UniqueName="ESTADO" FilterControlWidth="0px" >
                                            ...
                                            <%--<telerik:GridBoundColumn DataField="NOMBRE_VEHICULO" FilterControlAltText="Filter NOMBRE_VEHICULO column" HeaderText="Vehículo" ReadOnly="True"
                                                UniqueName="NOMBRE_VEHICULO" AutoPostBackOnFilter="True" FilterControlWidth="0px" AllowFiltering="False">
                                                <HeaderStyle Font-Bold="True" Width="0px" />
                                                <ItemStyle Width="0px" />
                                            </telerik:GridBoundColumn>--%>
                                            <telerik:GridBoundColumn DataField="CODIGO_VEHICULO" FilterControlAltText="Filter CODIGO_VEHICULO column" HeaderText="Cod. Vehículo" ReadOnly="True"
                                                UniqueName="CODIGO_VEHICULO" AutoPostBackOnFilter="True" FilterControlWidth="100px"  AllowFiltering="False">
                                            ...
                                            <telerik:GridBoundColumn DataField="CODIGO_CLIENTE" FilterControlAltText="Filter CODIGO_CLIENTE column" HeaderText="Cod. Cliente" ReadOnly="True"
                                                UniqueName="CODIGO_CLIENTE" AutoPostBackOnFilter="True" FilterControlWidth="0px" >
                                                <HeaderStyle Font-Bold="True" Width="0px" />
                                                <ItemStyle Width="0px" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="PLACA" FilterControlAltText="Filter PLACA column" HeaderText="Placa" ReadOnly="True"
                                                UniqueName="PLACA" AutoPostBackOnFilter="True" FilterControlWidth="0px" >
                                                <HeaderStyle Font-Bold="True" Width="0px" />
                                                <ItemStyle Width="0px" />
                                            </telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridBoundColumn DataField="MODELO" FilterControlAltText="Filter MODELO column" HeaderText="Modelo" ReadOnly="True"
                                                UniqueName="MODELO" AutoPostBackOnFilter="True" FilterControlWidth="200px" AllowFiltering="False">
                                            ...
                                            <telerik:GridBoundColumn DataField="TIPO" FilterControlAltText="Filter TIPO column" HeaderText="Tipo" ReadOnly="True"
                                                UniqueName="TIPO" AutoPostBackOnFilter="True" FilterControlWidth="140px" AllowFiltering="False">
                                                <HeaderStyle Font-Bold="True" Width="140px" />
                                                <ItemStyle Width="140px" />
                                            </telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridBoundColumn DataField="CIUDAD" FilterControlAltText="Filter CIUDAD column" HeaderText="Ciudad Taller" ReadOnly="True"
                                                UniqueName="CIUDAD" AutoPostBackOnFilter="True" FilterControlWidth="140px" >
                                                <HeaderStyle Font-Bold="True" Width="140px" />
                                                <ItemStyle Width="140px" />
                                            </telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridBoundColumn DataField="TURNO" FilterControlAltText="Filter TURNO column" HeaderText="Turno Programado" ReadOnly="True"
                                                UniqueName="TURNO" AutoPostBackOnFilter="True" FilterControlWidth="140px" AllowFiltering="False">
                                                <HeaderStyle Font-Bold="True" Width="140px" />
                                                <ItemStyle Width="140px" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="ANIO" FilterControlAltText="Filter ANIO column" HeaderText="Anio" ReadOnly="True"
                                                UniqueName="ANIO" AutoPostBackOnFilter="True" FilterControlWidth="0px"  >
                                                <HeaderStyle Font-Bold="True" Width="0px" />
                                                <ItemStyle Width="0px" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="ORDEN_SERVICIO" FilterControlAltText="Filter ORDEN_SERVICIO column" HeaderText="ORDEN_SERVICIO" ReadOnly="True"
                                                UniqueName="ORDEN_SERVICIO" AutoPostBackOnFilter="True" FilterControlWidth="0px" >
                                                <HeaderStyle Font-Bold="True" Width="0px" />
                                                <ItemStyle Width="0px" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="ORDEN_TRABAJO" FilterControlAltText="Filter ORDEN_TRABAJO column" HeaderText="ORDEN_TRABAJO" ReadOnly="True"
                                                UniqueName="ORDEN_TRABAJO" AutoPostBackOnFilter="True" FilterControlWidth="0px"  >
                                                <HeaderStyle Font-Bold="True" Width="0px" />
                                                <ItemStyle Width="0px" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="TIPO_TRANSACCION" FilterControlAltText="Filter TIPO_TRANSACCION column" HeaderText="TIPO_TRANSACCION" ReadOnly="True"
