...
Public Class ConsultaReporteConvenio
        ...
        Try
            If Not IsPostBack Then
                ...
                Else
                    Session("DetalleVehiculo") = Nothing
                    Detalle("Nuevo")
                    If Session("origen") = "C" Then
                        Image1.ImageUrl = "https://www.hunteronline.com.ec/IMGCOTIZADORWEB/Imagenescampanias/LogoCabeceraConvenioCoris.png"
                        Image2.ImageUrl = "https://www.hunteronline.com.ec/IMGCOTIZADORWEB/Imagenescampanias/LogoCorisAgua.png"
                    End If
                End If
                TituloReporte()
                CargaImagenQR()
