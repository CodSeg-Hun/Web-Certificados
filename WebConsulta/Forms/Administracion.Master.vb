...
Public Class Administracion
        ...
        Try
            If Not IsPostBack Then
                ...
                If Session.Item("user_session") IsNot Nothing Then
                    ...
                    If datosUsuarioLogin.Tables(0).Rows.Count > 0 Then ' ruccanales
                        Dim nombre As String = datosUsuarioLogin.Tables(0).Rows(0)("displayname").ToString()
                        Dim rucCanales As String = datosUsuarioLogin.Tables(0).Rows(0)("ruccanales").ToString()
                        Session("ruccanales") = rucCanales
                        ...
                        If (Session("user_id") = 2743) Then
                            Me.RadMenu1.Enabled = False
                            Me.RadMenu1.Visible = False
                            Me.BntSalir.Visible = False
                            Me.lbl_usuario_canal.Visible = False
                            Me.lbl_usuario_canal.Enabled = False
                        End If
    ...
    Protected Sub Llena_Menu()
        Try
            ...
            tipoMenu = "C"
            itemsMenu = objeto.Datos_Menu3(tipoMenu, usuarioSh)
            'Dim newRow As DataRow = itemsMenu.Tables(0).NewRow()

            ' Asigna valores a la nueva fila
            'newRow("CODIGO_MENU") = 953003
            'newRow("CODIGO_PADRE") = 9530
            'newRow("CAPTION_FORMA") = "Certificados SAC"
            'newRow("ASSEMBLY") = "~/Forms/ConsultaDatosNetsuite.aspx"
            'newRow("TIPO_MENU") = "C"

            ' Agrega la nueva fila al DataTable
            'itemsMenu.Tables(0).Rows.Add(newRow)
