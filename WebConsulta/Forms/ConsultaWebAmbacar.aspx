<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ConsultaWebAmbacar.aspx.vb" Inherits="WebConsulta.ConsultaWebAmbacar" EnableEventValidation = "false"%>
        ...
        <form id="form1" runat="server">
            ...
            <div id="container">
                <div id="banner">
                    ...
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/background_banner_certificado_ambacar.jpg" />
                        ...
                        <telerik:RadGrid ID="grdproductosdetalle" runat="server" CellSpacing="0" Culture="es-ES" GridLines="None" Width="400px" Skin="Transparent">
                            <MasterTableView AutoGenerateColumns="False">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn AllowFiltering="False" Display="False" FilterControlAltText="Filter column column"
                                        HeaderText="VIGENCIA DEL SERVICIO*" UniqueName="COBERTURA" DataFormatString="{0:dd/MMMM/yyyy}"
                                        DataField="fecha_fin">
                                        <FooterStyle BorderWidth="210px" />
                                        <HeaderStyle Font-Bold="True" HorizontalAlign="Center" Width="210px" />
                                        <ItemStyle Width="210px" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn AllowFiltering="False" Display="False" FilterControlAltText="Filter column column"
                                        HeaderText="INSTALACION" UniqueName="INSTALACION" DataFormatString="{0:dd/MMMM/yyyy}"
