<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ConsultaWebReporte2.aspx.vb" Inherits="WebConsulta.ConsultaWebReporte2" EnableEventValidation = "false"  %>
        ...
        <form id="form1" runat="server">
            ...
            <div id="container">
                <div id="banner">
                    ...
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/background_banner_certificado.jpg" />
                </div>
                <div id="content">
