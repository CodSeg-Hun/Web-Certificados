...
Public Class ConsultaDatosCasabaca
...
#Region "Procesos"
    ...
    Private Sub LimpiarControl()
        Try
            ...
            Me.mensajetexto.Text = "Nota: Este certificado no esta habilitado para presentar fechas de cobertura de servicio y/o precios"
        Catch ex As Exception
            Me.Mensaje(ex.Message, Operacion.OInvalida, ex)
            Enviar_Email(ex, CType(Application("usuario_email"), String))
        End Try
        ...
        Try
            ...
            If dtConsulta.Tables(0).Rows.Count > 0 Then
                ...
                If accionHabilita <> 0 Then
                    ...
                    dtVehiculo = obj.ConsultaCodigo(Me.txtCodVehiculo.Text, Me.txtConCodCliente.Text, cbm_tipo.SelectedValue.ToString)
...
#End Region
    ...
    Protected Sub Btnenviar(ByVal sender As Object, ByVal e As EventArgs) Handles BtnEnvia.Click, BtnEnvia.Click, BtnEnvia.Click
        Try
            ...
            Else
                ...
                obj.Registro_Actividad(Me.txtCodVehiculo.Text, Me.txtChasis.Text, Me.TxtMotor.Text, usuarioOficina, "S", ipmaquina, pantalla, Me.TxtCorreo.Text, False)
                TxtCorreo.Text = ""
                'If Not latam Then
    ...
    '        'Dim tablacliente As New PdfPTable(22)
    '        'tablacliente.SetWidths(New Single() {160.0F, 40.0F})
    '        'Dim codigoblan As New PdfPCell(New Phrase(" "))
    '        'codigoblan.Border = 0
    '        ''codigoblan.BackgroundColor = New BaseColor(230, 230, 230)
    '        'codigoblan.HorizontalAlignment = Element.ALIGN_RIGHT
    '        'tablacliente.AddCell(codigoblan)
    '        ''Dim codigoveh As New PdfPCell(New Phrase("C.V. " & Me.txtCodVehiculo.Text, fontcv))
    '        ''codigoveh.Border = 0
    '        ''codigoveh.BackgroundColor = New BaseColor(230, 230, 230)
    '        ''codigoveh.HorizontalAlignment = Element.ALIGN_RIGHT
    ...
    '        ElseIf cbm_tipo.SelectedValue.ToString = "D" Then
    '            texto2 = "Certifica que se ha realizado la desinstalación de nuestros productos del (Vehículo/Barco/Cajero) con las siguientes características:"
    '        ElseIf cbm_tipo.SelectedValue.ToString = "I" Then
    '            texto2 = "Certifica que se ha realizado la instalación de nuestros productos en el (Vehículo/Barco/Cajero) con las siguientes características:"
    '        End If
