...
Public Class creacionpdf_ins
    ...
    Public Overrides Sub OnEndPage(ByVal writer As PdfWriter, ByVal doc As Document)
        ...
        Dim logo As iTextSharp.text.Image = iTextSharp.text.Image.GetInstance(HttpContext.Current.Server.MapPath("../Images/background_banner_certificado_ins3.jpg"))
